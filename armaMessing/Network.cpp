...
void Network::CacheNetworkClient(bool State) {
...
void Network::CacheIdentities(bool State) { //we cant really use the autoarray class becuase the class assumes data is located
